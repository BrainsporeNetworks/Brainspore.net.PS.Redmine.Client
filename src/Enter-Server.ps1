...
.OUTPUTS
This Cmdlet returns a [biz.dfch.CS.Redmine.Client.RedmineClient] with a references to a redmine server. On failure it returns $null.
...
PS > $redmine = Enter-Server $ServerBaseUri $BaseUrl -Credential $Credential -TotalAttempts $TotalAttempts -BaseRetryIntervallMilliseconds $BaseRetryIntervallMilliseconds;
PS > $redmine
TotalAttempts                  : 3
...
biz.dfch.CS.Redmine.Client.RedmineClient

.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Redmine/Client/Enter-Server/

.NOTES
See module manifest for required software versions and dependencies at: 
http://dfch.biz/biz/dfch/PS/Redmine/Client/biz.dfch.PS.Redmine.Client.psd1/
#>

[CmdletBinding(
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Redmine/Client/Enter-Server/'
)]
Param 
(
...
PROCESS
{
	...
	$client = New-Object biz.dfch.CS.Redmine.Client.RedmineClient;
	Contract-Assert ($client -is [biz.dfch.CS.Redmine.Client.RedmineClient])
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUuoZ0cQ97hhoPMuwn4A3HZ9k6
# awugghHCMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRNp1wdx9y+eDo1
# wZhfTUOOdqyN3DANBgkqhkiG9w0BAQEFAASCAQClRwWJSfSC5XJui6iiddNDS2ET
# XeiCxnzSLma4K7J1bVhQ1eUQMQtoWbiRuhvyK4LI3G5JBTIRLsNja7URt6BaJH/Q
# FSrCcB1M+iy+9jB3CAtOZiQNrF+9F1jBVtTS/FlWTBOoDwtvkWVqoqNg4GRGQDUX
# YQXfYTb9y1iRWOBmPjyY0u0R0ql3LIHvATjzdy4GoXo7MId/PDouNnaCgyGblSS2
# IH342C62BDg5v5EjI3T1yxI5zfSHcjTc9GEbsEZSDNr2gOIF95jbO/5WqwqnNueV
# njzyBgkT9woNZ5uBAWmv+hFLithBxtZMtebQWfey2Vie2FEkaWfN07LmPlGdoYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEh1pmnZJc+8fhCfukZzFNBFDAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE2
# MDcxMzA2NDUxM1owIwYJKoZIhvcNAQkEMRYEFJ8xXpbukRIfrIepBOej+hICQG0T
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUY7gvq2H1g5CWlQULACScUCkz
# 7HkwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# 1pmnZJc+8fhCfukZzFNBFDANBgkqhkiG9w0BAQEFAASCAQA4P0iGFT1eNIPf6So5
# MSSFSoSI4LYfjkpjy1e5IlrnaNVYlnb07yIAjvc05ieHVUSR6ge399O0g+NJiKhY
# 6DbHBC2qqsmPcKxfuoLVdyJ69iOpuGX7LRoCp5WICoDwumW4EIcAJ0kxDCRAAXEs
# oukG6EpPhh8TeDvWKepVeIIF9eB5T7U9o+8xZSfXgSP4uTAS54PrLnJ05gFoDpwe
# lpU5sQ4YC5L5iYOXnpj5esJW5tH0xQOz079RWvOMt1wbfr6O353OAAdbllWobtdN
# 4fjyK3TcdaSrL9wiltvdQ3ylMVx35N9Q1yhO3qZs4nVUQ5oDvz2xtSXlZ4tpYhnn
# tYem
