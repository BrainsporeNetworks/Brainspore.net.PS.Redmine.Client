...
Set-Variable gotoSuccess -Option 'Constant' -Value 'net.BrainsporeSystem.Exception.gotoSuccess';
Set-Variable gotoError -Option 'Constant' -Value 'net.BrainsporeSystem.Exception.gotoError';
Set-Variable gotoFailure -Option 'Constant' -Value 'net.BrainsporeSystem.Exception.gotoFailure';
Set-Variable gotoNotFound -Option 'Constant' -Value 'net.BrainsporeSystem.Exception.gotoNotFound';
...
Contract-Requires ((Get-Module net.BrainsporePS.System.Logging).Version -ge ([Version] '1.3.1'))
Contract-Requires ((Get-Module net.BrainsporePS.System.Utilities).Version -ge ([Version] '1.1.0'))